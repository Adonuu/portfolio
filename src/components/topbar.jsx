...
export function TopBar() {
  return (
    <header>
      <nav className="flex w-4/5 gap-2 justify-between items-center p-4 lg:w-3/5 mx-auto">
        <div className="flex gap-3 items-center">
          ...
          <div className="flex gap-3">
            <a href="https://github.com/Adonuu" target="_blank" rel="noopener noreferrer" className="relative group">
              <svg
                className="sm:w-8 w-6 text-white group-hover:text-blue-500 transition-all duration-300 transform group-hover:scale-125"
        ...
        <div className="hidden gap-2 lg:flex  lg:ml-auto mt-2 lg:mt-0">
