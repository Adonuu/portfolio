    ...
    <header>
      <nav className="flex flex-wrap gap-2 justify-between items-center p-4 w-3/5 mx-auto">
        <div className="flex gap-3 items-center">
          ...
          <div className="flex gap-3">
            <a href="https://github.com/Adonuu" target="_blank" rel="noopener noreferrer">
              <svg className="sm:w-8 w-6" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="flex gap-2 lg:ml-auto mt-2 lg:mt-0">
          <Link className="text-lg" to="/resume">Resume</Link>
          <Link className="text-lg" to="/work">Work</Link>
        </div>
      </nav>
