...
export function TopBar() {
  return (
    <header>
      <nav className="flex flex-wrap gap-2 justify-between items-center p-4 w-3/5 mx-auto">
        <div className="flex gap-3 items-center">
          ...
          <div className="flex gap-3">
            <a href="https://github.com/Adonuu" target="_blank" rel="noopener noreferrer" className="relative group">
              <svg
                className="sm:w-8 w-6 text-white group-hover:text-blue-500 transition-all duration-300"
              ...
              <span className="absolute left-0 bottom-[-4px] w-full h-[2px] bg-blue-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
            </a>
        ...
        <div className="flex gap-2 lg:ml-auto mt-2 lg:mt-0">
      ...
      <div className="h-0.25 bg-white w-3/5 mx-auto"></div>
    </header>
  );
}
